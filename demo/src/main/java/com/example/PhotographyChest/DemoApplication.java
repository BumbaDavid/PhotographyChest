...
public class DemoApplication {
	...
	CommandLineRunner runner(CredentialsRepository credentialsRepository, CategoriesRepository categoriesRepository,PortofolioRepository portofolioRepository) {
		return args -> {
			...
			portofolioRepository.save(new Portofolio("https://i.pinimg.com/564x/52/ac/e2/52ace226f596840df6c2ea6fedc06e1f.jpg", values.get(3) , 11,credentials.get(0)));
			portofolioRepository.save(new Portofolio("https://i.pinimg.com/564x/c4/57/58/c457583f2e285a7722826b3be8ee1885.jpg",values.get(1) , 22,credentials.get(0)));
			portofolioRepository.save(new Portofolio("https://i.pinimg.com/564x/7e/06/00/7e060036b8733dcb70c49e2500ffbc11.jpg",values.get(0) , 33,credentials.get(0)));
			portofolioRepository.save(new Portofolio("https://i.pinimg.com/564x/2d/31/8e/2d318e6bda0a9442f4ebc559b3ec806b.jpg", values.get(3), 44,credentials.get(0)));
			portofolioRepository.save(new Portofolio("https://i.pinimg.com/564x/a2/c8/9f/a2c89fbadf19088a5fa8bfbb4dc524e8.jpg",values.get(4) , 55,credentials.get(0)));
			portofolioRepository.save(new Portofolio("https://i.pinimg.com/564x/a0/58/36/a05836173fb0694bc4dbb04b37530735.jpg",values.get(2) , 66,credentials.get(0)));
			//nature
